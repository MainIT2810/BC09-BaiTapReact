...
import ChairList from "./DanhSachGhe.jsx";
import ChairPuttingList from "./DanhSachGheDangDat.jsx";
  ...
  render() {
    return (
     <div className="container">
       <h1 className="text-success text-center mt-3">ĐẶT VÉ XE BUÝT HÃNG CYBERSOFT</h1>
        <div className="row">
        <div className="col-6">
          <ChairList
